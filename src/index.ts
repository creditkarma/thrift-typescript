...
function generateServicesAST(services: any[]): string {
  ...
  services.forEach(function(service) {
    ...
    let _classStatement = ts.createStatement(_classExpression);

    _classStatement = ts.addSyntheticLeadingComment(_classStatement, ts.SyntaxKind.SingleLineCommentTrivia, '', false);
    _classStatement = ts.addSyntheticLeadingComment(_classStatement, ts.SyntaxKind.SingleLineCommentTrivia, ' Autogenerated by thrift-typescript', false);
    _classStatement = ts.addSyntheticLeadingComment(_classStatement, ts.SyntaxKind.SingleLineCommentTrivia, '', false);
    _classStatement = ts.addSyntheticLeadingComment(_classStatement, ts.SyntaxKind.SingleLineCommentTrivia, ' DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING', false);
    _classStatement = ts.addSyntheticLeadingComment(_classStatement, ts.SyntaxKind.SingleLineCommentTrivia, '', true);
