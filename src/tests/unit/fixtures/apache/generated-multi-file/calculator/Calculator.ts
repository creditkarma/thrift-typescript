    ...
    public static read(input: thrift.TProtocol): AddResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_25: operation.JankyResult = operation.JankyResult.read(input);
                        _args.exp = value_25;
                    }
                    else {
                        input.skip(fieldType);
    ...
    public static read(input: thrift.TProtocol): CalculateResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_29: operation.JankyOperation = operation.JankyOperation.read(input);
                        _args.ouch = value_29;
                    }
                    else {
                        input.skip(fieldType);
...
export class MapOneListResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_34: number): void => {
                output.writeI32(value_34);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
...
export class MapValuesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.I32, this.success.length);
            this.success.forEach((value_37: number): void => {
                output.writeI32(value_37);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): MapValuesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_38: Array<number> = new Array<number>();
...
export class ListToMapResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_40: string, key_3: string): void => {
    ...
    public static read(input: thrift.TProtocol): FetchThingResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_43: common.CommonStruct = common.CommonStruct.read(input);
