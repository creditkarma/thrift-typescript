...
export class AddInt64__Result extends thrift.StructLike implements IAddInt64__Result {
    ...
    constructor(args: IAddInt64__ResultArgs = {}) {
        super();
        if (args.success != null) {
            const value_53: thrift.Int64 = (typeof args.success === "number" ? new thrift.Int64(args.success) : typeof args.success === "string" ? thrift.Int64.fromDecimalString(args.success) : args.success);
