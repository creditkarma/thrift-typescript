...
export interface IHandler<Context = any> {
    getStruct(key: number, context?: Context): __NAMESPACE__.ISharedStruct | Promise<__NAMESPACE__.ISharedStruct>;
    getUnion(index: number, context?: Context): __NAMESPACE__.ISharedUnion | Promise<__NAMESPACE__.ISharedUnion>;
}
export class Processor<Context = any> extends thrift.ThriftProcessor<Context, IHandler<Context>> {
    ...
    public process_getStruct(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol, context: Context): Promise<Buffer> {
        return new Promise<__NAMESPACE__.ISharedStruct>((resolve, reject): void => {
            try {
        ...
        }).then((data: __NAMESPACE__.ISharedStruct): Buffer => {
    ...
    public process_getUnion(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol, context: Context): Promise<Buffer> {
        return new Promise<__NAMESPACE__.ISharedUnion>((resolve, reject): void => {
            try {
        ...
        }).then((data: __NAMESPACE__.ISharedUnion): Buffer => {
