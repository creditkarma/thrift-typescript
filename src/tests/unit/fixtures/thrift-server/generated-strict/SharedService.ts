/* tslint:disable */
/*
 * Autogenerated by @creditkarma/thrift-typescript v4.0.0-9
...
export interface ILocalHandler<Context extends object = {}> {
    getUnion(index: number, context: thrift.ThriftContext<Context>): SharedUnion.SharedUnionArgs | Promise<SharedUnion.SharedUnionArgs>;
...
export class Processor<Context extends object = {}> implements thrift.IThriftProcessor<Context> {
    ...
    private process_getUnion(args: IGetUnion__Args, requestId: number, context: thrift.ThriftContext<Context>): Promise<Buffer> {
    ...
    private process_getEnum(args: IGetEnum__Args, requestId: number, context: thrift.ThriftContext<Context>): Promise<Buffer> {
