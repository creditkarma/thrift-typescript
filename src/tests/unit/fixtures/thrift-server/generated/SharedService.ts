    ...
    decode(input: thrift.TProtocol): IGetUnion__Result {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: SharedUnion.ISharedUnion = SharedUnion.SharedUnionCodec.decode(input);
...
export class GetUnion__Result extends thrift.StructLike implements IGetUnion__Result {
    ...
    constructor(args: IGetUnion__ResultArgs = {}) {
        super();
        if (args.success != null) {
            const value_8: SharedUnion.ISharedUnion = new SharedUnion.SharedUnion(args.success);
